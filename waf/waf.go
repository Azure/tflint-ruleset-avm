...
var Rules = []tflint.Rule{
	...
	AzurermWindowsVirtualMachineZoneUnknown(),
	AzurermLinuxVirtualMachineZoneUnknown(),
	AzurermVirtualMachineZonesUnknown(),
	AzurermLegacyVirtualMachineNotAllowed(),
	AzurermWindowsVirtualMachineOSDiskDefaultSSD(),
	AzurermLinuxVirtualMachineOSDiskDefaultSSD(),
	AzurermManagedDiskStorageAccountType(),
	AzurermVirtualNetworkGatewaySku(),
	AzurermVirtualNetworkGatewayVpnActiveActive(),
}
