...
// This test checks that the virtual network gateway is one of the zone redundance sku's.  ERGWScale is currently in preview and isn't included.
...
func AzurermVirtualNetworkGatewayVpnActiveActive() *attrvalue.SimpleRule[bool] {
