...
func main() {
	...
	fmt.Fprintln(w, "This document lists all rules currently registered in this ruleset. AVM rules are enabled by default and support `error`, `warning`, or `notice` severity overrides in TFLint configuration.") //nolint:errcheck // writes to bufio.Writer; errors are caught at Flush
	fmt.Fprintln(w)                                                                                                                                                                                                 //nolint:errcheck // writes to bufio.Writer; errors are caught at Flush
